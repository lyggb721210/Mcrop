...
message = {
    ...
    "help": {
        ...
        + Style.RESET_ALL
        + "'是终点\n祝您游玩愉快 \n按Enter键退出。",
        "2": "This is a map breaking game .\nIn the game, you can enter w, a, s, and d to control"
        + user
        + Style.RESET_ALL
    ...
    "input_err": {"1": "请输入正确的数字", "2": "Please enter the correct number."},
    "save_load_err1": {
        "1": Fore.RED
        + "error:存档加载错误"
        + Style.RESET_ALL
    ...
    "autosafed": {"1": "已自动保存", "2": "Automatically saved"},
    "go_on_game": {"1": " 3.继续游戏", "2": " 3.Continue the game"},
    "clean_save": {
        "1": " 4.清除存档和语言并退出",
...
def display_message(message_dict, language, end="\n"):
    print(message_dict.get(language), end=end)
